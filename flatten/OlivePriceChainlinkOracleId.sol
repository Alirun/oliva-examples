// Dependency file: @chainlink/contracts/src/v0.5/vendor/Buffer.sol
...
// Dependency file: @chainlink/contracts/src/v0.5/vendor/CBOR.sol

// pragma solidity ^0.5.0;

// import "@chainlink/contracts/src/v0.5/vendor/Buffer.sol";
...
// Dependency file: @chainlink/contracts/src/v0.5/Chainlink.sol

// pragma solidity ^0.5.0;

// import { CBOR as CBOR_Chainlink, Buffer as Buffer_Chainlink } from "@chainlink/contracts/src/v0.5/vendor/CBOR.sol";
...
// Dependency file: @chainlink/contracts/src/v0.5/interfaces/ENSInterface.sol
...
// Dependency file: @chainlink/contracts/src/v0.5/interfaces/LinkTokenInterface.sol
...
// Dependency file: @chainlink/contracts/src/v0.5/interfaces/ChainlinkRequestInterface.sol
...
// Dependency file: @chainlink/contracts/src/v0.5/interfaces/PointerInterface.sol
...
// Dependency file: @chainlink/contracts/src/v0.5/vendor/ENSResolver.sol
...
// Dependency file: @chainlink/contracts/src/v0.5/vendor/SafeMath.sol
...
// Dependency file: @chainlink/contracts/src/v0.5/ChainlinkClient.sol

// pragma solidity ^0.5.0;

// import "@chainlink/contracts/src/v0.5/Chainlink.sol";
// import "@chainlink/contracts/src/v0.5/interfaces/ENSInterface.sol";
// import "@chainlink/contracts/src/v0.5/interfaces/LinkTokenInterface.sol";
// import "@chainlink/contracts/src/v0.5/interfaces/ChainlinkRequestInterface.sol";
// import "@chainlink/contracts/src/v0.5/interfaces/PointerInterface.sol";
// import { ENSResolver as ENSResolver_Chainlink } from "@chainlink/contracts/src/v0.5/vendor/ENSResolver.sol";
// import { SafeMath as SafeMath_Chainlink } from "@chainlink/contracts/src/v0.5/vendor/SafeMath.sol";
...
// Dependency file: opium-contracts/contracts/Interface/IOracleId.sol
...
// Dependency file: openzeppelin-solidity/contracts/utils/ReentrancyGuard.sol
...
// Dependency file: opium-contracts/contracts/Errors/OracleAggregatorErrors.sol
...
// Dependency file: opium-contracts/contracts/OracleAggregator.sol
...
// import "opium-contracts/contracts/Errors/OracleAggregatorErrors.sol";
...
// Root file: contracts/oracles/chainlink/OlivePriceChainlinkOracleId.sol
...
contract OlivePriceChainlinkOracleId is ChainlinkClient, IOracleId, Ownable {
  ...
  constructor(OracleAggregator _oracleAggregator, uint256 _emergencyPeriod) public {
    ...
    Rinkeby
     */
    oracle = 0x29CE4C76e6aaA0670751290AC167eeF4B1c6F3E3;
    jobId = "90624339fabd4c64bbbcf37a007a423e";
    fee = 5 * 10 **16; // 0.05 LINK
    price = 0;
    /*
    {
  ...
  function setOracle(address _oracle, uint256 _fee, bytes32 _jobId) external {
    oracle = _oracle;
    jobId = _jobId;
    fee = _fee;
  }
